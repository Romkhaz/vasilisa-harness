...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using Vasilisa.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage:
      'Anonymous usage data helps improve Vasilisa. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
