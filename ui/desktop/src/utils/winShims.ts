...
/**
 * Ensures Windows shims are available in %LOCALAPPDATA%\Vasilisa\bin
 * This allows the bundled executables to be found via PATH regardless of where Vasilisa is installed
 */
